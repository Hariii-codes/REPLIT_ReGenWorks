#!/bin/bash
# Database Setup Helper for ReGenWorks
...
echo -e "${YELLOW}ReGenWorks Database Setup Helper${NC}"
...
read -p "Enter database name [regenworks]: " DB_NAME
DB_NAME=${DB_NAME:-regenworks}
